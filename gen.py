...
def loader():
    return (
        ...
        '<div class="ls-hero"><div class="ls-hero-logo">PIKENHOT</div><div class="ls-hero-sub"></div></div>'
        '<div class="ls-body">'
...
CONTACT_MODAL = (
    ...
    '<p style="color:var(--text3);font-size:13px">We&#39;ll be in touch within 24 hours.</p>'
    '</div>'
    '</div>'
    '</div>'
)
...
def build_index():
    return (
        ...
        '<div class="hb-url">pikenhot.ie</div>'
        '</div>'
        '<div class="hb-body">'
        '<div class="hb-hero-section">'
        '<div class="hb-brand">PIKENHOT</div>'
        ...
        '<div class="hbadge-text"><strong>pikenhot.ie</strong><span>Live &mdash; Complete Package</span></div>'
        '</div>'
        ...
        '<h2 class="section-title">What Irish wellness<br><span class="gt">businesses say.</span></h2>'
        '</div>'
        ...
        '<div class="testi-text">"The website Kryson built us looks incredible. Our members constantly comment on how easy it is to use. Online bookings are up significantly since launch."</div>'
        '<div class="testi-author"><div class="testi-avatar">S</div><div><div class="testi-name">Sean O&#39;Brien</div><div class="testi-biz">Evolve Fitness, Dublin</div></div></div>'
        '</div>'
        '<div class="testi-card reveal">'
        '<div class="testi-stars"><span class="star">&#9733;</span><span class="star">&#9733;</span><span class="star">&#9733;</span><span class="star">&#9733;</span><span class="star">&#9733;</span></div>'
        '<div class="testi-text">"The Complete package was exactly what we needed. Members manage their own accounts, the admin dashboard is incredible. Worth every cent."</div>'
        '<div class="testi-author"><div class="testi-avatar">A</div><div><div class="testi-name">Aoife Kelly</div><div class="testi-biz">Urban Sauna, Cork</div></div></div>'
        '</div>'
        '<div class="testi-card reveal">'
        '<div class="testi-stars"><span class="star">&#9733;</span><span class="star">&#9733;</span><span class="star">&#9733;</span><span class="star">&#9733;</span><span class="star">&#9733;</span></div>'
        '<div class="testi-text">"Zero enquiries from my old site. Two weeks after going live with Kryson I had 12 new clients contact me. The local SEO is genuinely impressive."</div>'
        '<div class="testi-author"><div class="testi-avatar">C</div><div><div class="testi-name">Ciara Brennan</div><div class="testi-biz">Personal Trainer, Galway</div></div></div>'
        '</div>'
        '</div>'
        '</div>'
        '</section>'
...
def build_contact():
    return (
        ...
        '<div class="cf-ok">&#10003;</div>'
        '<h3>Message received!</h3>'
        '<p style="color:var(--text3);font-size:13px">We&#39;ll get back to you within 24 hours.</p>'
        '</div>'
        '</div>'
